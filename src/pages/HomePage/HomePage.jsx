            ...
            <Container className='media'>
                <Row className='video'>
                    <Col className='text'>
                        ...
                        <p>El éxito de nuestra empresa es el resultado de la colaboración entre nuestros empleados, nuestros clientes, y los productos de la empresa.</p>
                    </Col>
                    <ReactPlayer url={video} playing={true} volume={.2} />
                </Row>
                    <h4>Construye tus sueños, renueva tus espacios</h4>
                <Row className='pic'>
                    <Image src={imgOne}/>
                    <Image src={imgTwo}/>
                </Row>
